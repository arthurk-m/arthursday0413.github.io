$(document).ready(function() {
  const header = (work, aboutMe) => `
  <header class ="heading">
  <div class="work"><a href="${work}">Work</a></div>
    <div class="home"><a href="${aboutMe}">Arthur Kim</a></div>
  </header>`;

  $("#projectHeader").html(header("../../index.html", "../../aboutMe.html"));
});
